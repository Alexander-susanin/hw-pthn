...
x1 = int(input('Введите x1 вектора: '))
y1 = int(input('Введите y1 вектора: '))
z1 = int(input('Введите z1 вектора: '))
x2 = int(input('Введите x2 вектора: '))
y2 = int(input('Введите y2 вектора: '))
z2 = int(input('Введите z2 вектора: '))
